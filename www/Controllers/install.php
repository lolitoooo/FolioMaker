    ...
    public function setup_site(): void
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] === $configForm["config"]["method"]) {
            ...
            if ($verificator->checkForm($configForm, $_POST, $errors)) {
                ...
                ";
                $mail->sendMail($_POST["site_email"], $message, $subject);

                // Supprimer les fichiers d'installations
                unlink(__DIR__ . './www/Controllers/Installer.php');
                // unlink(__DIR__ . '/www/Forms/Setup.php');
                // $installerViewPath = __DIR__ . '/www/View/Installer';
                // if (is_dir($installerViewPath)) {
                //     // Supprimer tous les fichiers dans le dossier (facultatif)
                //     $files = glob($installerViewPath . '/*');
                //     foreach ($files as $file) {
                //         unlink($file);
                //     }
                //     // Supprimer le dossier lui-même
                //     rmdir($installerViewPath);
                // }
